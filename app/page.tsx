          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-xl text-gray-600 leading-relaxed">
                    Crafted for ambitious professionals who demand excellence. Our smooth, rich cold brew delivers
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-amber-100 to-orange-100 rounded-full blur-3xl opacity-30 scale-75"></div>
              </div>
            </div>
          </div>
        </section>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-sm text-gray-400">
            <p>&copy; {new Date().getFullYear()} BrewCraft. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
